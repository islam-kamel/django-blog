...
class Profile(models.Model):
    ...
    image_cover = models.ImageField(default='cover.jpg', upload_to='profile_cover')
    ...
    def save(self, *args, **kwargs):
        ...
        elif img_cover.width > 1250 or img_cover.height > 450 and img_cover.width < 1000 or img_cover.height < 250:
